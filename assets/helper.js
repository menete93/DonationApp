function getFontFamily(sizeCode, weightStyle) {
  ...
  let fontStyle = '';
  switch(weight) {
    case 100: fontStyle = 'Thin'; break;
    case 200: fontStyle = 'ExtraLight'; break;
    case 300: fontStyle = 'Light'; break;
    case 400: fontStyle = 'Regular'; break;
    case 500: fontStyle = 'Medium'; break;
    case 600: fontStyle = 'SemiBold'; break;
    case 700: fontStyle = 'Bold'; break;
    case 800: fontStyle = 'ExtraBold'; break;
    case 900: fontStyle = 'Black'; break;
    default: throw new Error("Peso inválido");
  }
